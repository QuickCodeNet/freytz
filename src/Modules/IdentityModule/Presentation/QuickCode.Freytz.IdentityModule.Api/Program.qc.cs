...
using QuickCode.Freytz.Infrastructure.Web.Filters;
...
using QuickCode.Freytz.IdentityModule.Api.Extension;
using QuickCode.Freytz.IdentityModule.Persistence;
using QuickCode.Freytz.IdentityModule.Persistence.Stores;
using QuickCode.Freytz.Infrastructure.Data.Mappers;
using Serilog;
using QuickCode.Freytz.Infrastructure.Web.Auditing;
using QuickCode.Freytz.Infrastructure.Web.Middleware;
using QuickCode.Freytz.Infrastructure.Web.ExceptionHandling;
using QuickCode.Freytz.IdentityModule.Api;
...
builder.Services.AddQuickCodeRepositories("QuickCode.Freytz.IdentityModule.Persistence", "QuickCode.Freytz.IdentityModule.Application");
