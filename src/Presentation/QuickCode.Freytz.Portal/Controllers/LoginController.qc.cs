...
using LoginRequest = QuickCode.Freytz.Infrastructure.Integration.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.Freytz.Infrastructure.Integration.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.Freytz.Infrastructure.Integration.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;

namespace QuickCode.Freytz.Portal.Controllers
{
