...
namespace QuickCode.Freytz.Infrastructure.Integration.Nswag.Extensions
{
    public static class NswagExtensions
    {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            ...
            string namespacePrefix = "QuickCode.Freytz.Infrastructure.Integration.Nswag.Clients.")
        {
        ...
        public static void AddServiceClient(this IServiceCollection services, IConfiguration configuration,
            Type type, bool addRetryHandler = false,
            string namespacePrefix = "QuickCode.Freytz.")
        {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            Assembly assembly, bool addRetryHandler=false, string namespacePrefix = "QuickCode.Freytz.Infrastructure.Integration.Nswag.Clients.")
        {
