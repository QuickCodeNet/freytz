# 🚀 Freytz - Generated Microservice Platform
...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/freytz.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.Freytz.Docker.sln
  ```
...
**Freytz** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
freytz/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.Freytz.Gateway/
      QuickCode.Freytz.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/freytz)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://freytz-gateway.quickcode.net](https://freytz-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://freytz-portal.quickcode.net](https://freytz-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://freytz-gateway.quickcode.net](https://freytz-gateway.quickcode.net)
- **Portal:**
    - link: [https://freytz-portal.quickcode.net](https://freytz-portal.quickcode.net)
- **Module APIs:**
    - link: [https://freytz-identity-module.quickcode.net](https://freytz-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["freytz-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://freytz-identity-module.quickcode.net"
        }
      }
    }
  }
...
1. Open `src/QuickCode.Freytz.Docker.sln` in Rider.
...
**Last generation Time**: [Generated on: 2026-07-25 19:30:36 UTC]